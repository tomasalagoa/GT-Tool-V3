...
public class NISTJulietCMDIGoodTests {
    ...
    public NISTJulietCMDIGoodTests(){}
    ...
    public void connecttcp_test01() throws Exception{
        spec.setFunction(new FuncDefinition("good", "CWE78_OS_Command_Injection__connect_tcp_01"));
    ...
    public void connecttcp_test10() throws Exception{
        spec.setFunction(new FuncDefinition("good", "CWE78_OS_Command_Injection__connect_tcp_10"));
        spec.setSensitiveFunctions(List.of(new FuncDefinition("exec")));
        spec.setUntrustedDataSources(List.of("BufferedReader"));
    ...
    public void connecttcp_test45() throws Exception{
        spec.setFunction(new FuncDefinition("good", "CWE78_OS_Command_Injection__connect_tcp_45"));
        spec.setSensitiveFunctions(List.of(new FuncDefinition("exec")));
        spec.setUntrustedDataSources(List.of("BufferedReader"));
    ...
    public void connecttcp_test67() throws Exception{
        spec.setFunction(new FuncDefinition("good", "CWE78_OS_Command_Injection__connect_tcp_67a"));
        spec.setSensitiveFunctions(List.of(new FuncDefinition("exec")));
        spec.setUntrustedDataSources(List.of("BufferedReader"));
    ...
    public void consolereadline_test05() throws Exception{
        spec.setFunction(new FuncDefinition("good", "CWE78_OS_Command_Injection__console_readLine_05"));
        spec.setSensitiveFunctions(List.of(new FuncDefinition("exec")));
        spec.setUntrustedDataSources(List.of("BufferedReader"));
    ...
    public void consolereadline_test15() throws Exception{
        spec.setFunction(new FuncDefinition("good", "CWE78_OS_Command_Injection__console_readLine_15"));
        spec.setSensitiveFunctions(List.of(new FuncDefinition("exec")));
        spec.setUntrustedDataSources(List.of("BufferedReader"));
    ...
    public void consolereadline_test51() throws Exception{
        spec.setFunction(new FuncDefinition("good", "CWE78_OS_Command_Injection__console_readLine_51a"));
        spec.setSensitiveFunctions(List.of(new FuncDefinition("exec")));
        spec.setUntrustedDataSources(List.of("BufferedReader"));
    ...
    public void consolereadline_test71() throws Exception{
        spec.setFunction(new FuncDefinition("good", "CWE78_OS_Command_Injection__console_readLine_71a"));
        spec.setSensitiveFunctions(List.of(new FuncDefinition("exec")));
        spec.setUntrustedDataSources(List.of("BufferedReader"));
    ...
    public void database_test06() throws Exception{
        spec.setFunction(new FuncDefinition("good", "CWE78_OS_Command_Injection__database_06"));
        spec.setSensitiveFunctions(List.of(new FuncDefinition("exec")));
    ...
    public void database_test16() throws Exception{
        spec.setFunction(new FuncDefinition("good", "CWE78_OS_Command_Injection__database_16"));
        spec.setSensitiveFunctions(List.of(new FuncDefinition("exec"),
    ...
    public void database_test61() throws Exception{
        spec.setFunction(new FuncDefinition("good", "CWE78_OS_Command_Injection__database_61a"));
        spec.setSensitiveFunctions(List.of(new FuncDefinition("exec")));
        spec.setUntrustedDataSources(List.of("ResultSet"));
    ...
    public void database_test75() throws Exception{
        spec.setFunction(new FuncDefinition("good", "CWE78_OS_Command_Injection__database_75a"));
        spec.setSensitiveFunctions(List.of(new FuncDefinition("exec")));
    ...
    public void environment_test07() throws Exception{
        spec.setFunction(new FuncDefinition("good", "CWE78_OS_Command_Injection__Environment_07"));
        spec.setSensitiveFunctions(List.of(new FuncDefinition("exec")));
    ...
    public void environment_test17() throws Exception{
        spec.setFunction(new FuncDefinition("good", "CWE78_OS_Command_Injection__Environment_17"));
        spec.setSensitiveFunctions(List.of(new FuncDefinition("exec")));
        spec.setGlobalTaintVariableRegex(List.of("System"));
    ...
    public void environment_test53() throws Exception{
        spec.setFunction(new FuncDefinition("good", "CWE78_OS_Command_Injection__Environment_53a"));
        spec.setSensitiveFunctions(List.of(new FuncDefinition("exec")));
        spec.setGlobalTaintVariableRegex(List.of("System"));
    ...
    public void file_test10() throws Exception{
        spec.setFunction(new FuncDefinition("good", "CWE78_OS_Command_Injection__File_10"));
        spec.setSensitiveFunctions(List.of(new FuncDefinition("exec")));
        spec.setUntrustedDataSources(List.of("BufferedReader"));
    ...
    public void file_test21() throws Exception{
        spec.setFunction(new FuncDefinition("good", "CWE78_OS_Command_Injection__File_21"));
        spec.setSensitiveFunctions(List.of(new FuncDefinition("exec")));
        spec.setUntrustedDataSources(List.of("BufferedReader"));
    ...
    public void file_test67() throws Exception{
        spec.setFunction(new FuncDefinition("good", "CWE78_OS_Command_Injection__File_67a"));
        spec.setSensitiveFunctions(List.of(new FuncDefinition("exec")));
        spec.setUntrustedDataSources(List.of("BufferedReader"));
    ...
    public void file_test81() throws Exception{
        spec.setFunction(new FuncDefinition("good", "CWE78_OS_Command_Injection__File_81a"));
        spec.setSensitiveFunctions(List.of(new FuncDefinition("exec")));
        spec.setUntrustedDataSources(List.of("BufferedReader"));
    ...
    public void getcookies_test15() throws Exception{
        spec.setFunction(new FuncDefinition("good", "CWE78_OS_Command_Injection__getCookies_Servlet_15"));
        spec.setSensitiveFunctions(List.of(new FuncDefinition("exec")));
    ...
    public void getcookies_test22() throws Exception{
        spec.setFunction(new FuncDefinition("good", "CWE78_OS_Command_Injection__getCookies_Servlet_22a"));
        spec.setSensitiveFunctions(List.of(new FuncDefinition("exec")));
        spec.setTaintedVarsOrArgs(List.of("request", "response"));
    ...
    public void getcookies_test71() throws Exception{
        spec.setFunction(new FuncDefinition("good", "CWE78_OS_Command_Injection__getCookies_Servlet_71a"));
        spec.setSensitiveFunctions(List.of(new FuncDefinition("exec")));
        spec.setTaintedVarsOrArgs(List.of("request", "response"));
    ...
    public void getparameter_test16() throws Exception{
        spec.setFunction(new FuncDefinition("good", "CWE78_OS_Command_Injection__getParameter_Servlet_16"));
        spec.setSensitiveFunctions(List.of(new FuncDefinition("exec")));
        spec.setTaintedVarsOrArgs(List.of("request", "response"));
    ...
    public void getparameter_test31() throws Exception{
        spec.setFunction(new FuncDefinition("good", "CWE78_OS_Command_Injection__getParameter_Servlet_31"));
        spec.setSensitiveFunctions(List.of(new FuncDefinition("exec")));
        spec.setTaintedVarsOrArgs(List.of("request", "response"));
    ...
    public void getparameter_test75() throws Exception{
        spec.setFunction(new FuncDefinition("good", "CWE78_OS_Command_Injection__getParameter_Servlet_75a"));
        spec.setSensitiveFunctions(List.of(new FuncDefinition("exec")));
        spec.setTaintedVarsOrArgs(List.of("request", "response"));
    ...
    public void getquery_test17() throws Exception{
        spec.setFunction(new FuncDefinition("good", "CWE78_OS_Command_Injection__getQueryString_Servlet_17"));
        spec.setSensitiveFunctions(List.of(new FuncDefinition("exec")));
        spec.setTaintedVarsOrArgs(List.of("request", "response"));
    ...
    public void getquery_test41() throws Exception{
        spec.setFunction(new FuncDefinition("good", "CWE78_OS_Command_Injection__getQueryString_Servlet_41"));
        spec.setSensitiveFunctions(List.of(new FuncDefinition("exec")));
        spec.setTaintedVarsOrArgs(List.of("request", "response"));
    ...
    public void getquery_test81() throws Exception{
        spec.setFunction(new FuncDefinition("good", "CWE78_OS_Command_Injection__getQueryString_Servlet_81a"));
        spec.setSensitiveFunctions(List.of(new FuncDefinition("exec")));
        spec.setTaintedVarsOrArgs(List.of("request", "response"));
    ...
    public void listentcp_test01() throws Exception{
        spec.setFunction(new FuncDefinition("good", "CWE78_OS_Command_Injection__listen_tcp_01"));
        spec.setSensitiveFunctions(List.of(new FuncDefinition("exec")));
        spec.setUntrustedDataSources(List.of("BufferedReader"));
    ...
    public void listentcp_test21() throws Exception{
        spec.setFunction(new FuncDefinition("good", "CWE78_OS_Command_Injection__listen_tcp_21"));
        spec.setSensitiveFunctions(List.of(new FuncDefinition("exec")));
        spec.setUntrustedDataSources(List.of("BufferedReader"));
    ...
    public void listentcp_test45() throws Exception{
        spec.setFunction(new FuncDefinition("good", "CWE78_OS_Command_Injection__listen_tcp_45"));
        spec.setSensitiveFunctions(List.of(new FuncDefinition("exec")));
        spec.setUntrustedDataSources(List.of("BufferedReader"));
    ...
    public void propertiesfile_test06() throws Exception{
        spec.setFunction(new FuncDefinition("good", "CWE78_OS_Command_Injection__PropertiesFile_06"));
        spec.setSensitiveFunctions(List.of(new FuncDefinition("exec")));
    ...
    public void propertiesfile_test31() throws Exception{
        spec.setFunction(new FuncDefinition("good", "CWE78_OS_Command_Injection__PropertiesFile_31"));
        spec.setSensitiveFunctions(List.of(new FuncDefinition("exec")));
        spec.setUntrustedDataSources(List.of("Properties"));
    ...
    public void propertiesfile_test53() throws Exception{
        spec.setFunction(new FuncDefinition("good", "CWE78_OS_Command_Injection__PropertiesFile_53a"));
        spec.setSensitiveFunctions(List.of(new FuncDefinition("exec")));
        spec.setUntrustedDataSources(List.of("Properties"));
    ...
    public void property_test05() throws Exception{
        spec.setFunction(new FuncDefinition("good", "CWE78_OS_Command_Injection__Property_05"));
        spec.setSensitiveFunctions(List.of(new FuncDefinition("exec")));
        spec.setGlobalTaintVariableRegex(List.of("System"));
    ...
    public void property_test22() throws Exception{
        spec.setFunction(new FuncDefinition("good", "CWE78_OS_Command_Injection__Property_22a"));
        spec.setSensitiveFunctions(List.of(new FuncDefinition("exec")));
        spec.setGlobalTaintVariableRegex(List.of("System"));
    ...
    public void property_test51() throws Exception{
        spec.setFunction(new FuncDefinition("good", "CWE78_OS_Command_Injection__Property_51a"));
        spec.setSensitiveFunctions(List.of(new FuncDefinition("exec")));
        spec.setGlobalTaintVariableRegex(List.of("System"));
    ...
    public void urlconnection_test07() throws Exception{
        spec.setFunction(new FuncDefinition("good", "CWE78_OS_Command_Injection__URLConnection_07"));
        spec.setSensitiveFunctions(List.of(new FuncDefinition("exec")));
        spec.setUntrustedDataSources(List.of("BufferedReader"));
    ...
    public void urlconnection_test41() throws Exception{
        spec.setFunction(new FuncDefinition("good", "CWE78_OS_Command_Injection__URLConnection_41"));
        spec.setSensitiveFunctions(List.of(new FuncDefinition("exec")));
        spec.setUntrustedDataSources(List.of("BufferedReader"));
    ...
    public void urlconnection_test61() throws Exception{
        spec.setFunction(new FuncDefinition("good", "CWE78_OS_Command_Injection__URLConnection_61a"));
        spec.setSensitiveFunctions(List.of(new FuncDefinition("exec")));
        spec.setUntrustedDataSources(List.of("BufferedReader"));
