...
public class NISTJulietSQLITests {
    ...
    public void connecttcp_test01() throws Exception{
        spec.setFunction(new FuncDefinition("bad", "CWE89_SQL_Injection__connect_tcp_execute_01"));
    ...
    public void connecttcp_test10() throws Exception{
        spec.setFunction(new FuncDefinition("bad", "CWE89_SQL_Injection__connect_tcp_executeBatch_10"));
        spec.setSensitiveFunctions(List.of(new FuncDefinition("execute"), 
            new FuncDefinition("executeBatch"), new FuncDefinition("executeQuery"),
            new FuncDefinition("executeUpdate")));
        spec.setUntrustedDataSources(List.of("BufferedReader"));
    ...
    public void connecttcp_test45() throws Exception{
        spec.setFunction(new FuncDefinition("bad", "CWE89_SQL_Injection__connect_tcp_executeQuery_45"));
        spec.setSensitiveFunctions(List.of(new FuncDefinition("execute"), 
            new FuncDefinition("executeBatch"), new FuncDefinition("executeQuery"),
            new FuncDefinition("executeUpdate")));
        spec.setUntrustedDataSources(List.of("BufferedReader"));
    ...
    public void connecttcp_test67() throws Exception{
        spec.setFunction(new FuncDefinition("bad", "CWE89_SQL_Injection__connect_tcp_executeUpdate_67a"));
        spec.setSensitiveFunctions(List.of(new FuncDefinition("execute"), 
            new FuncDefinition("executeBatch"), new FuncDefinition("executeQuery"),
            new FuncDefinition("executeUpdate")));
        spec.setUntrustedDataSources(List.of("BufferedReader"));
    ...
    public void consolereadline_test05() throws Exception{
        spec.setFunction(new FuncDefinition("bad", "CWE89_SQL_Injection__console_readLine_prepareStatement_05"));
        spec.setSensitiveFunctions(List.of(new FuncDefinition("execute"), 
            new FuncDefinition("executeBatch"), new FuncDefinition("executeQuery"),
            new FuncDefinition("executeUpdate")));
        spec.setUntrustedDataSources(List.of("BufferedReader"));
    ...
    public void consolereadline_test15() throws Exception{
        spec.setFunction(new FuncDefinition("bad", "CWE89_SQL_Injection__console_readLine_execute_15"));
        spec.setSensitiveFunctions(List.of(new FuncDefinition("execute"), 
            new FuncDefinition("executeBatch"), new FuncDefinition("executeQuery"),
            new FuncDefinition("executeUpdate")));
        spec.setUntrustedDataSources(List.of("BufferedReader"));
    ...
    public void consolereadline_test51() throws Exception{
        spec.setFunction(new FuncDefinition("bad", "CWE89_SQL_Injection__console_readLine_executeBatch_51a"));
        spec.setSensitiveFunctions(List.of(new FuncDefinition("execute"), 
            new FuncDefinition("executeBatch"), new FuncDefinition("executeQuery"),
            new FuncDefinition("executeUpdate")));
        spec.setUntrustedDataSources(List.of("BufferedReader"));
    ...
    public void consolereadline_test71() throws Exception{
        spec.setFunction(new FuncDefinition("bad", "CWE89_SQL_Injection__console_readLine_executeQuery_71a"));
        spec.setSensitiveFunctions(List.of(new FuncDefinition("execute"), 
            new FuncDefinition("executeBatch"), new FuncDefinition("executeQuery"),
            new FuncDefinition("executeUpdate")));
        spec.setUntrustedDataSources(List.of("BufferedReader"));
    ...
    public void database_test06() throws Exception{
        spec.setFunction(new FuncDefinition("bad", "CWE89_SQL_Injection__database_executeUpdate_06"));
        spec.setSensitiveFunctions(List.of(new FuncDefinition("execute"), 
            new FuncDefinition("executeBatch"), new FuncDefinition("executeQuery"),
            new FuncDefinition("executeUpdate")));
    ...
    public void database_test16() throws Exception{
        spec.setFunction(new FuncDefinition("bad", "CWE89_SQL_Injection__database_prepareStatement_16"));
        spec.setSensitiveFunctions(List.of(new FuncDefinition("execute"), 
            new FuncDefinition("executeBatch"), new FuncDefinition("executeQuery"),
            new FuncDefinition("executeUpdate")));
        spec.setUntrustedDataSources(List.of("ResultSet"));
    ...
    public void database_test61() throws Exception{
        spec.setFunction(new FuncDefinition("bad", "CWE89_SQL_Injection__database_execute_61a"));
        spec.setSensitiveFunctions(List.of(new FuncDefinition("execute"), 
            new FuncDefinition("executeBatch"), new FuncDefinition("executeQuery"),
            new FuncDefinition("executeUpdate")));
        spec.setUntrustedDataSources(List.of("ResultSet"));
    ...
    public void database_test75() throws Exception{
        spec.setFunction(new FuncDefinition("bad", "CWE89_SQL_Injection__database_executeBatch_75a"));
        spec.setSensitiveFunctions(List.of(new FuncDefinition("execute"), 
            new FuncDefinition("executeBatch"), new FuncDefinition("executeQuery"),
            new FuncDefinition("executeUpdate")));
    ...
    public void environment_test07() throws Exception{
        spec.setFunction(new FuncDefinition("bad", "CWE89_SQL_Injection__Environment_executeQuery_07"));
        spec.setSensitiveFunctions(List.of(new FuncDefinition("execute"), 
            new FuncDefinition("executeBatch"), new FuncDefinition("executeQuery"),
            new FuncDefinition("executeUpdate")));
    ...
    public void environment_test17() throws Exception{
        spec.setFunction(new FuncDefinition("bad", "CWE89_SQL_Injection__Environment_executeUpdate_17"));
        spec.setSensitiveFunctions(List.of(new FuncDefinition("execute"), 
            new FuncDefinition("executeBatch"), new FuncDefinition("executeQuery"),
            new FuncDefinition("executeUpdate")));
        spec.setGlobalTaintVariableRegex(List.of("System"));
    ...
    public void environment_test53() throws Exception{
        spec.setFunction(new FuncDefinition("bad", "CWE89_SQL_Injection__Environment_prepareStatement_53a"));
        spec.setSensitiveFunctions(List.of(new FuncDefinition("execute"), 
            new FuncDefinition("executeBatch"), new FuncDefinition("executeQuery"),
            new FuncDefinition("executeUpdate")));
        spec.setGlobalTaintVariableRegex(List.of("System"));
    ...
    public void file_test10() throws Exception{
        spec.setFunction(new FuncDefinition("bad", "CWE89_SQL_Injection__File_execute_10"));
        spec.setSensitiveFunctions(List.of(new FuncDefinition("execute"), 
            new FuncDefinition("executeBatch"), new FuncDefinition("executeQuery"),
            new FuncDefinition("executeUpdate")));
        spec.setUntrustedDataSources(List.of("BufferedReader"));
    ...
    public void file_test21() throws Exception{
        spec.setFunction(new FuncDefinition("bad", "CWE89_SQL_Injection__File_executeBatch_21"));
        spec.setSensitiveFunctions(List.of(new FuncDefinition("execute"), 
            new FuncDefinition("executeBatch"), new FuncDefinition("executeQuery"),
            new FuncDefinition("executeUpdate")));
        spec.setUntrustedDataSources(List.of("BufferedReader"));
    ...
    public void file_test67() throws Exception{
        spec.setFunction(new FuncDefinition("bad", "CWE89_SQL_Injection__File_executeQuery_67a"));
        spec.setSensitiveFunctions(List.of(new FuncDefinition("execute"), 
            new FuncDefinition("executeBatch"), new FuncDefinition("executeQuery"),
            new FuncDefinition("executeUpdate")));
        spec.setUntrustedDataSources(List.of("BufferedReader"));
    ...
    public void file_test81() throws Exception{
        spec.setFunction(new FuncDefinition("bad", "CWE89_SQL_Injection__File_executeUpdate_81a"));
        spec.setSensitiveFunctions(List.of(new FuncDefinition("execute"), 
            new FuncDefinition("executeBatch"), new FuncDefinition("executeQuery"),
            new FuncDefinition("executeUpdate")));
        spec.setUntrustedDataSources(List.of("BufferedReader"));
    ...
    public void getcookies_test15() throws Exception{
        spec.setFunction(new FuncDefinition("bad", "CWE89_SQL_Injection__getCookies_Servlet_prepareStatement_15"));
        spec.setSensitiveFunctions(List.of(new FuncDefinition("execute"), 
            new FuncDefinition("executeBatch"), new FuncDefinition("executeQuery"),
            new FuncDefinition("executeUpdate")));
    ...
    public void getcookies_test22() throws Exception{
        spec.setFunction(new FuncDefinition("bad", "CWE89_SQL_Injection__getCookies_Servlet_execute_22a"));
        spec.setSensitiveFunctions(List.of(new FuncDefinition("execute"), 
            new FuncDefinition("executeBatch"), new FuncDefinition("executeQuery"),
            new FuncDefinition("executeUpdate")));
        spec.setTaintedVarsOrArgs(List.of("request", "response"));
    ...
    public void getcookies_test71() throws Exception{
        spec.setFunction(new FuncDefinition("bad", "CWE89_SQL_Injection__getCookies_Servlet_executeBatch_71a"));
        spec.setSensitiveFunctions(List.of(new FuncDefinition("execute"), 
            new FuncDefinition("executeBatch"), new FuncDefinition("executeQuery"),
            new FuncDefinition("executeUpdate")));
        spec.setTaintedVarsOrArgs(List.of("request", "response"));
    ...
    public void getparameter_test16() throws Exception{
        spec.setFunction(new FuncDefinition("bad", "CWE89_SQL_Injection__getParameter_Servlet_executeQuery_16"));
        spec.setSensitiveFunctions(List.of(new FuncDefinition("execute"), 
            new FuncDefinition("executeBatch"), new FuncDefinition("executeQuery"),
            new FuncDefinition("executeUpdate")));
        spec.setTaintedVarsOrArgs(List.of("request", "response"));
    ...
    public void getparameter_test31() throws Exception{
        spec.setFunction(new FuncDefinition("bad", "CWE89_SQL_Injection__getParameter_Servlet_executeUpdate_31"));
        spec.setSensitiveFunctions(List.of(new FuncDefinition("execute"), 
            new FuncDefinition("executeBatch"), new FuncDefinition("executeQuery"),
            new FuncDefinition("executeUpdate")));
        spec.setTaintedVarsOrArgs(List.of("request", "response"));
    ...
    public void getparameter_test75() throws Exception{
        spec.setFunction(new FuncDefinition("bad", "CWE89_SQL_Injection__getParameter_Servlet_prepareStatement_75a"));
        spec.setSensitiveFunctions(List.of(new FuncDefinition("execute"), 
            new FuncDefinition("executeBatch"), new FuncDefinition("executeQuery"),
            new FuncDefinition("executeUpdate")));
        spec.setTaintedVarsOrArgs(List.of("request", "response"));
    ...
    public void getquery_test17() throws Exception{
        spec.setFunction(new FuncDefinition("bad", "CWE89_SQL_Injection__getQueryString_Servlet_execute_17"));
        spec.setSensitiveFunctions(List.of(new FuncDefinition("execute"), 
            new FuncDefinition("executeBatch"), new FuncDefinition("executeQuery"),
            new FuncDefinition("executeUpdate")));
        spec.setTaintedVarsOrArgs(List.of("request", "response"));
    ...
    public void getquery_test41() throws Exception{
        spec.setFunction(new FuncDefinition("bad", "CWE89_SQL_Injection__getQueryString_Servlet_executeBatch_41"));
        spec.setSensitiveFunctions(List.of(new FuncDefinition("execute"), 
            new FuncDefinition("executeBatch"), new FuncDefinition("executeQuery"),
            new FuncDefinition("executeUpdate")));
        spec.setTaintedVarsOrArgs(List.of("request", "response"));
    ...
    public void getquery_test81() throws Exception{
        spec.setFunction(new FuncDefinition("bad", "CWE89_SQL_Injection__getQueryString_Servlet_executeQuery_81a"));
        spec.setSensitiveFunctions(List.of(new FuncDefinition("execute"), 
            new FuncDefinition("executeBatch"), new FuncDefinition("executeQuery"),
            new FuncDefinition("executeUpdate")));
        spec.setTaintedVarsOrArgs(List.of("request", "response"));
    ...
    public void listentcp_test01() throws Exception{
        spec.setFunction(new FuncDefinition("bad", "CWE89_SQL_Injection__listen_tcp_executeUpdate_01"));
        spec.setSensitiveFunctions(List.of(new FuncDefinition("execute"), 
            new FuncDefinition("executeBatch"), new FuncDefinition("executeQuery"),
            new FuncDefinition("executeUpdate")));
        spec.setUntrustedDataSources(List.of("BufferedReader"));
    ...
    public void listentcp_test21() throws Exception{
        spec.setFunction(new FuncDefinition("bad", "CWE89_SQL_Injection__listen_tcp_prepareStatement_21"));
        spec.setSensitiveFunctions(List.of(new FuncDefinition("execute"), 
            new FuncDefinition("executeBatch"), new FuncDefinition("executeQuery"),
            new FuncDefinition("executeUpdate")));
        spec.setUntrustedDataSources(List.of("BufferedReader"));
    ...
    public void listentcp_test45() throws Exception{
        spec.setFunction(new FuncDefinition("bad", "CWE89_SQL_Injection__listen_tcp_execute_45"));
        spec.setSensitiveFunctions(List.of(new FuncDefinition("execute"), 
            new FuncDefinition("executeBatch"), new FuncDefinition("executeQuery"),
            new FuncDefinition("executeUpdate")));
        spec.setUntrustedDataSources(List.of("BufferedReader"));
    ...
    public void propertiesfile_test06() throws Exception{
        spec.setFunction(new FuncDefinition("bad", "CWE89_SQL_Injection__PropertiesFile_executeBatch_06"));
        spec.setSensitiveFunctions(List.of(new FuncDefinition("execute"), 
            new FuncDefinition("executeBatch"), new FuncDefinition("executeQuery"),
            new FuncDefinition("executeUpdate")));
    ...
    public void propertiesfile_test31() throws Exception{
        spec.setFunction(new FuncDefinition("bad", "CWE89_SQL_Injection__PropertiesFile_executeQuery_31"));
        spec.setSensitiveFunctions(List.of(new FuncDefinition("execute"), 
            new FuncDefinition("executeBatch"), new FuncDefinition("executeQuery"),
            new FuncDefinition("executeUpdate")));
        spec.setUntrustedDataSources(List.of("Properties"));
    ...
    public void propertiesfile_test53() throws Exception{
        spec.setFunction(new FuncDefinition("bad", "CWE89_SQL_Injection__PropertiesFile_executeUpdate_53a"));
        spec.setSensitiveFunctions(List.of(new FuncDefinition("execute"), 
            new FuncDefinition("executeBatch"), new FuncDefinition("executeQuery"),
            new FuncDefinition("executeUpdate")));
        spec.setUntrustedDataSources(List.of("Properties"));
    ...
    public void property_test05() throws Exception{
        spec.setFunction(new FuncDefinition("bad", "CWE89_SQL_Injection__Property_prepareStatement_05"));
        spec.setSensitiveFunctions(List.of(new FuncDefinition("execute"), 
            new FuncDefinition("executeBatch"), new FuncDefinition("executeQuery"),
            new FuncDefinition("executeUpdate")));
        spec.setGlobalTaintVariableRegex(List.of("System"));
    ...
    public void property_test22() throws Exception{
        spec.setFunction(new FuncDefinition("bad", "CWE89_SQL_Injection__Property_execute_22a"));
        spec.setSensitiveFunctions(List.of(new FuncDefinition("execute"), 
            new FuncDefinition("executeBatch"), new FuncDefinition("executeQuery"),
            new FuncDefinition("executeUpdate")));
        spec.setGlobalTaintVariableRegex(List.of("System"));
    ...
    public void property_test51() throws Exception{
        spec.setFunction(new FuncDefinition("bad", "CWE89_SQL_Injection__Property_executeBatch_51a"));
        spec.setSensitiveFunctions(List.of(new FuncDefinition("execute"), 
            new FuncDefinition("executeBatch"), new FuncDefinition("executeQuery"),
            new FuncDefinition("executeUpdate")));
        spec.setGlobalTaintVariableRegex(List.of("System"));
    ...
    public void urlconnection_test07() throws Exception{
        spec.setFunction(new FuncDefinition("bad", "CWE89_SQL_Injection__URLConnection_executeQuery_07"));
        spec.setSensitiveFunctions(List.of(new FuncDefinition("execute"), 
            new FuncDefinition("executeBatch"), new FuncDefinition("executeQuery"),
            new FuncDefinition("executeUpdate")));
        spec.setUntrustedDataSources(List.of("BufferedReader"));
    ...
    public void urlconnection_test41() throws Exception{
        spec.setFunction(new FuncDefinition("bad", "CWE89_SQL_Injection__URLConnection_executeUpdate_41"));
        spec.setSensitiveFunctions(List.of(new FuncDefinition("execute"), 
            new FuncDefinition("executeBatch"), new FuncDefinition("executeQuery"),
            new FuncDefinition("executeUpdate")));
        spec.setUntrustedDataSources(List.of("BufferedReader"));
    ...
    public void urlconnection_test61() throws Exception{
        spec.setFunction(new FuncDefinition("bad", "CWE89_SQL_Injection__URLConnection_prepareStatement_61a"));
        spec.setSensitiveFunctions(List.of(new FuncDefinition("execute"), 
            new FuncDefinition("executeBatch"), new FuncDefinition("executeQuery"),
            new FuncDefinition("executeUpdate")));
        spec.setUntrustedDataSources(List.of("BufferedReader"));
