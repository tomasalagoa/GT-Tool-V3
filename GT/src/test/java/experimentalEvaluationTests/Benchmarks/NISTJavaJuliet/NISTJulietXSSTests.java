...
public class NISTJulietXSSTests {
    ...
    public void connecttcp_test01() throws Exception{
        spec.setFunction(new FuncDefinition("bad", "CWE80_XSS__CWE182_Servlet_connect_tcp_01"));
    ...
    public void connecttcp_test10() throws Exception{
        spec.setFunction(new FuncDefinition("bad", "CWE80_XSS__CWE182_Servlet_connect_tcp_10"));
        spec.setSensitiveFunctions(List.of(new FuncDefinition("println")));
        spec.setTaintedVarsOrArgs(List.of("request", "response"));
        spec.setUntrustedDataSources(List.of("BufferedReader"));
    ...
    public void connecttcp_test45() throws Exception{
        spec.setFunction(new FuncDefinition("bad", "CWE80_XSS__CWE182_Servlet_connect_tcp_45"));
        spec.setSensitiveFunctions(List.of(new FuncDefinition("println")));
        spec.setTaintedVarsOrArgs(List.of("request", "response"));
        spec.setUntrustedDataSources(List.of("BufferedReader"));
    ...
    public void connecttcp_test67() throws Exception{
        spec.setFunction(new FuncDefinition("bad", "CWE80_XSS__Servlet_connect_tcp_67a"));
        spec.setSensitiveFunctions(List.of(new FuncDefinition("println")));
        spec.setTaintedVarsOrArgs(List.of("request", "response"));
        spec.setUntrustedDataSources(List.of("BufferedReader"));
    ...
    public void file_test10() throws Exception{
        spec.setFunction(new FuncDefinition("bad", "CWE80_XSS__CWE182_Servlet_File_10"));
        spec.setSensitiveFunctions(List.of(new FuncDefinition("println")));
        spec.setTaintedVarsOrArgs(List.of("request", "response"));
        spec.setUntrustedDataSources(List.of("BufferedReader"));
    ...
    public void file_test21() throws Exception{
        spec.setFunction(new FuncDefinition("bad", "CWE80_XSS__CWE182_Servlet_File_21"));
        spec.setSensitiveFunctions(List.of(new FuncDefinition("println")));
        spec.setTaintedVarsOrArgs(List.of("request", "response"));
        spec.setUntrustedDataSources(List.of("BufferedReader"));
    ...
    public void file_test67() throws Exception{
        spec.setFunction(new FuncDefinition("bad", "CWE80_XSS__Servlet_File_67a"));
        spec.setSensitiveFunctions(List.of(new FuncDefinition("println")));
        spec.setTaintedVarsOrArgs(List.of("request", "response"));
        spec.setUntrustedDataSources(List.of("BufferedReader"));
    ...
    public void file_test81() throws Exception{
        spec.setFunction(new FuncDefinition("bad", "CWE80_XSS__Servlet_File_81a"));
        spec.setSensitiveFunctions(List.of(new FuncDefinition("println")));
        spec.setTaintedVarsOrArgs(List.of("request", "response"));
        spec.setUntrustedDataSources(List.of("BufferedReader"));
    ...
    public void getcookies_test15() throws Exception{
        spec.setFunction(new FuncDefinition("bad", "CWE80_XSS__CWE182_Servlet_getCookies_Servlet_15"));
        spec.setSensitiveFunctions(List.of(new FuncDefinition("println")));
        spec.setTaintedVarsOrArgs(List.of("request", "response"));
    ...
    public void getcookies_test22() throws Exception{
        spec.setFunction(new FuncDefinition("bad", "CWE80_XSS__CWE182_Servlet_getCookies_Servlet_22a"));
        spec.setSensitiveFunctions(List.of(new FuncDefinition("println")));
        spec.setTaintedVarsOrArgs(List.of("request", "response"));
    ...
    public void getcookies_test71() throws Exception{
        spec.setFunction(new FuncDefinition("bad", "CWE80_XSS__Servlet_getCookies_Servlet_71a"));
        spec.setSensitiveFunctions(List.of(new FuncDefinition("println")));
        spec.setTaintedVarsOrArgs(List.of("request", "response"));
    ...
    public void getparameter_test16() throws Exception{
        spec.setFunction(new FuncDefinition("bad", "CWE80_XSS__CWE182_Servlet_getParameter_Servlet_16"));
        spec.setSensitiveFunctions(List.of(new FuncDefinition("println")));
        spec.setTaintedVarsOrArgs(List.of("request", "response"));
    ...
    public void getparameter_test31() throws Exception{
        spec.setFunction(new FuncDefinition("bad", "CWE80_XSS__CWE182_Servlet_getParameter_Servlet_31"));
        spec.setSensitiveFunctions(List.of(new FuncDefinition("println")));
        spec.setTaintedVarsOrArgs(List.of("request", "response"));
    ...
    public void getparameter_test75() throws Exception{
        spec.setFunction(new FuncDefinition("bad", "CWE80_XSS__Servlet_getParameter_Servlet_75a"));
        spec.setSensitiveFunctions(List.of(new FuncDefinition("println")));
        spec.setTaintedVarsOrArgs(List.of("request", "response"));
    ...
    public void getquery_test17() throws Exception{
        spec.setFunction(new FuncDefinition("bad", "CWE80_XSS__CWE182_Servlet_getQueryString_Servlet_17"));
        spec.setSensitiveFunctions(List.of(new FuncDefinition("println")));
        spec.setTaintedVarsOrArgs(List.of("request", "response"));
    ...
    public void getquery_test41() throws Exception{
        spec.setFunction(new FuncDefinition("bad", "CWE80_XSS__CWE182_Servlet_getQueryString_Servlet_41"));
        spec.setSensitiveFunctions(List.of(new FuncDefinition("println")));
        spec.setTaintedVarsOrArgs(List.of("request", "response"));
    ...
    public void getquery_test81() throws Exception{
        spec.setFunction(new FuncDefinition("bad", "CWE80_XSS__Servlet_getQueryString_Servlet_81a"));
        spec.setSensitiveFunctions(List.of(new FuncDefinition("println")));
        spec.setTaintedVarsOrArgs(List.of("request", "response"));
    ...
    public void listentcp_test01() throws Exception{
        spec.setFunction(new FuncDefinition("bad", "CWE80_XSS__CWE182_Servlet_listen_tcp_01"));
        spec.setSensitiveFunctions(List.of(new FuncDefinition("println")));
        spec.setUntrustedDataSources(List.of("BufferedReader"));
    ...
    public void listentcp_test21() throws Exception{
        spec.setFunction(new FuncDefinition("bad", "CWE80_XSS__CWE182_Servlet_listen_tcp_21"));
        spec.setSensitiveFunctions(List.of(new FuncDefinition("println")));
        spec.setUntrustedDataSources(List.of("BufferedReader"));
    ...
    public void listentcp_test45() throws Exception{
        spec.setFunction(new FuncDefinition("bad", "CWE80_XSS__CWE182_Servlet_listen_tcp_45"));
        spec.setSensitiveFunctions(List.of(new FuncDefinition("println")));
        spec.setUntrustedDataSources(List.of("BufferedReader"));
    ...
    public void propertiesfile_test06() throws Exception{
        spec.setFunction(new FuncDefinition("bad", "CWE80_XSS__CWE182_Servlet_PropertiesFile_06"));
        spec.setSensitiveFunctions(List.of(new FuncDefinition("println")));
    ...
    public void propertiesfile_test31() throws Exception{
        spec.setFunction(new FuncDefinition("bad", "CWE80_XSS__CWE182_Servlet_PropertiesFile_31"));
        spec.setSensitiveFunctions(List.of(new FuncDefinition("println")));
        spec.setUntrustedDataSources(List.of("Properties"));
    ...
    public void propertiesfile_test53() throws Exception{
        spec.setFunction(new FuncDefinition("bad", "CWE80_XSS__CWE182_Servlet_PropertiesFile_53a"));
        spec.setSensitiveFunctions(List.of(new FuncDefinition("println")));
        spec.setUntrustedDataSources(List.of("Properties"));
    ...
    public void urlconnection_test07() throws Exception{
        spec.setFunction(new FuncDefinition("bad", "CWE80_XSS__CWE182_Servlet_URLConnection_07"));
        spec.setSensitiveFunctions(List.of(new FuncDefinition("println")));
        spec.setUntrustedDataSources(List.of("BufferedReader"));
    ...
    public void urlconnection_test41() throws Exception{
        spec.setFunction(new FuncDefinition("bad", "CWE80_XSS__CWE182_Servlet_URLConnection_41"));
        spec.setSensitiveFunctions(List.of(new FuncDefinition("println")));
        spec.setUntrustedDataSources(List.of("BufferedReader"));
    ...
    public void urlconnection_test61() throws Exception{
        spec.setFunction(new FuncDefinition("bad", "CWE80_XSS__CWE182_Servlet_URLConnection_61a"));
        spec.setSensitiveFunctions(List.of(new FuncDefinition("println")));
        spec.setUntrustedDataSources(List.of("BufferedReader"));
