...
public class PythonParserBaseListener implements PythonParserListener {
     ...
     */
    @Override
    public void exitString_literal(PythonParser.String_literalContext ctx) {
    }
     ...
     */
    @Override
    public void exitName_literal(PythonParser.Name_literalContext ctx) {
    }
     ...
     */
    @Override
    public void exitTrue_false(PythonParser.True_falseContext ctx) {
    }
