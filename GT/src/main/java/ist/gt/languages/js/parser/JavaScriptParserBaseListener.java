...
public class JavaScriptParserBaseListener implements JavaScriptParserListener {
     ...
     */
    @Override
    public void enterFunctionCallExpression(JavaScriptParser.FunctionCallExpressionContext ctx) {
    }
     ...
     */
    @Override
    public void exitFunctionCallExpression(JavaScriptParser.FunctionCallExpressionContext ctx) {
    }
     ...
     */
    @Override
    public void enterLet(JavaScriptParser.LetContext ctx) {
    }
     ...
     */
    @Override
    public void exitLet(JavaScriptParser.LetContext ctx) {
    }
